...
- **Γ thresholds.** Start from literature-typical values and tune so you neither label everything nor miss failures. Document the thresholds used.
...
### Step 9 — Physical validation (comparative with MEAM where appropriate)
...
### Step 10 — Conventions and critical caveats
